...
Usage:
    ...
    python3 kernels/bench_mfma_rotate.py
    python3 kernels/bench_mfma_rotate.py --skip-compile   # if HSACO already exists
    python3 kernels/bench_mfma_rotate.py --force-compile  # force recompilation
"""
